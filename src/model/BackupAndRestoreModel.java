...
public class BackupAndRestoreModel {
    ...
    public String backup(String backupPath) {
        ...
        try {
            ...
            p = runtime.exec("C:\\Program Files\\MySQL\\MySQL Server 8.0\\bin\\mysqldump.exe --host=localhost --port=3307 -uroot -pass34 --add-drop-database -B pamunuwila_hardware_db -r" + backupPath);
            logger.debug(p);
