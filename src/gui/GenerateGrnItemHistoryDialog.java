 ...
 */
public class GenerateGrnItemHistoryDialog extends javax.swing.JDialog {

    /**
     * Creates new form GenerateGrnItemHistoryDialog
     */
    static Logger logger = Logger.getLogger(GenerateGrnItemHistoryDialog.class.getName());
    
    String reportPath = "reports\\pamunuwila_hardware_grn_item_history.jasper";
    Map m = new HashMap();

    public GenerateGrnItemHistoryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        logger.debug("Access to GenerateGrnItemHistoryDialog.java");
...
//            java.util.logging.Logger.getLogger(GenerateGrnItemHistoryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GenerateGrnItemHistoryDialog dialog = new GenerateGrnItemHistoryDialog(new javax.swing.JFrame(), true);
