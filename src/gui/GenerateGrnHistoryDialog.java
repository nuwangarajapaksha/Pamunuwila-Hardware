 ...
 */
public class GenerateGrnHistoryDialog extends javax.swing.JDialog {

    /**
     * Creates new form GenerateGrnHistoryDialog
     */
    static Logger logger = Logger.getLogger(GenerateGrnHistoryDialog.class.getName());
    
    String reportPath = "reports\\pamunuwila_hardware_grn_history.jasper";
    Map m = new HashMap();
    
    public GenerateGrnHistoryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        logger.debug("Access to GenerateGrnHistoryDialog.java");
...
//            java.util.logging.Logger.getLogger(GenerateGrnHistoryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GenerateGrnHistoryDialog dialog = new GenerateGrnHistoryDialog(new javax.swing.JFrame(), true);
