...
public class UserManager extends javax.swing.JFrame {
    ...
    DefaultTableModel userTableModelFull;
    ...
    public UserManager() {
        initComponents();
        logger.debug("Access to UserManager.java");

        userTableModel = (DefaultTableModel) userTable.getModel();
        userTableModelFull = (DefaultTableModel) userTableFull.getModel();

        userModel = new UserModel();
        comboBoxLoadModel = new ComboBoxLoadModel();

        userModel.loadUserTable("", userTableModel);
        userModel.loadUserTableFull("", userTableModelFull);
    ...
    private void initComponents() {
        ...
        userTableFull = new javax.swing.JTable();
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Users", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 13))); // NOI18N
        ...
        userTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User No", "Name", "Email", "Contact No", "City", "Username", "Job Role"
            }
        ) {
        ...
        userTableFull.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "User No", "Name", "NIC", "Email ", "Contact No", "Address", "City", "District", "Province", "Username", "Job Role"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        userTableFull.setRowHeight(25);
        jScrollPane3.setViewportView(userTableFull);
    ...
    private void keywordFieldFullKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keywordFieldFullKeyReleased
        ...
        userModel.loadUserTableFull(keywordFull, userTableModelFull);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if (name.equals("")) {
            ...
            if (!m.matches()) {
                ...
                String result = userModel.updateUser(userNo, name, nic, email, contactNo, address, city, distictNo, provinceNo, username, password, jobroleNo);
                if (result.equals("Success")) {
                    JOptionPane.showConfirmDialog(rootPane, result, "Message", -1, 1);
                    userModel.loadUserTable("", userTableModel);
                    userModel.loadUserTableFull("", userTableModelFull);
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            String result = userModel.removeUser(userNo);
            if (result.equals("Success")) {
                JOptionPane.showConfirmDialog(rootPane, result, "Message", -1, 1);
                userModel.loadUserTable("", userTableModel);
                userModel.loadUserTableFull("", userTableModelFull);
    ...
    private void userTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTableMouseClicked
        ...
        int userNo = (int) userTableModel.getValueAt(row, 0);
        Object[] userData = userModel.getSelectedUserData(userNo);

        userNoField.setText(new String(userData[0] + ""));
        nameField.setText((String) userData[1]);
        nicField.setText((String) userData[2]);
        emailField.setText((String) userData[3]);
        contactNoField.setText((String) userData[4]);
        addressField.setText((String) userData[5]);
        cityField.setText((String) userData[6]);
        districtComboBox.setSelectedIndex((int) userData[7] - 1);
        provinceComboBox.setSelectedIndex((int) userData[8] - 1);
        usernameField.setText((String) userData[9]);
        PasswordField.setText((String) userData[10]);
        jobroleComboBox.setSelectedIndex((int) userData[11] - 1);

        if (userNoField.getText().length() > 0) {
    ...
    private void keywordFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keywordFieldKeyReleased
        ...
        userModel.loadUserTable(keyword, userTableModel);
...
//        }
    ...
    private javax.swing.JTable userTableFull;
