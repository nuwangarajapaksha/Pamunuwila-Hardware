 ...
 */
public class GenerateInvoiceHistoryDialog extends javax.swing.JDialog {

    /**
     * Creates new form GenerateInvoiceHistoryDialog
     */
    static Logger logger = Logger.getLogger(GenerateInvoiceHistoryDialog.class.getName());
    
    String reportPath = "reports\\pamunuwila_hardware_invoice_ history.jasper";
    Map m = new HashMap();
    
    public GenerateInvoiceHistoryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        logger.debug("Access to GenerateInvoiceHistoryDialog.java");
...
//            java.util.logging.Logger.getLogger(GenerateInvoiceHistoryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GenerateInvoiceHistoryDialog dialog = new GenerateInvoiceHistoryDialog(new javax.swing.JFrame(), true);
