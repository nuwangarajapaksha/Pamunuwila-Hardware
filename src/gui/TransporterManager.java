 ...
 */
public class TransporterManager extends javax.swing.JFrame {

    /**
     * Creates new form TransporterManager
     */
    private TransporterModel transporterModel;
    private ComboBoxLoadModel comboBoxLoadModel;
    static Logger logger = Logger.getLogger(TransporterManager.class.getName());

    DefaultTableModel transporterTableModel;
    DefaultTableModel transporterTableModelFull;

    DefaultComboBoxModel districtComboBoxModel;
    DefaultComboBoxModel provinceComboBoxModel;

    public TransporterManager() {
        initComponents();
        logger.debug("Access to TransporterManager.java");
        
        transporterTableModel = (DefaultTableModel) transporterTable.getModel();
        transporterTableModelFull = (DefaultTableModel) transporterTableFull.getModel();
        ...
        transporterModel.loadTransporterTableFull("", transporterTableModelFull);
    ...
    private void initComponents() {
        ...
        transporterNoField = new javax.swing.JTextField();
        ...
        transporterTableFull = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Transporter Manager");
        setResizable(false);
        ...
        transporterNoField.setEditable(false);
        ...
        jLabel1.setText("Transporter No");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(transporterNoField))))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(transporterNoField, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTabbedPane1.addTab("Transporter Details", jPanel1);
        ...
        transporterTableFull.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Transporter No", "Name", "NIC", "Email", "Contact No ", "Address", "City", "District", "Province"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        transporterTableFull.setRowHeight(25);
        jScrollPane3.setViewportView(transporterTableFull);
        ...
        jTabbedPane1.addTab("Transporters", jPanel3);
    ...
    private void keywordFieldFullKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keywordFieldFullKeyReleased
        ...
        transporterModel.loadTransporterTableFull(keywordFull, transporterTableModelFull);
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        if (name.equals("")) {
            ...
            if (!m.matches()) {
                ...
                String result = transporterModel.registerTransporter(name, nic, email, contactNo, address, city, distictNo, provinceNo);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        // TODO add your handling code here:
        String transporterNo = transporterNoField.getText();
        String name = nameField.getText();
        String nic = nicField.getText();
        String email = emailField.getText();
        String contactNo = contactNoField.getText();
        ...
        if (name.equals("")) {
            ...
            if (!m.matches()) {
                ...
                String result = transporterModel.updateTransporter(transporterNo, name, nic, email, contactNo, address, city, distictNo, provinceNo);
                if (result.equals("Success")) {
                    JOptionPane.showConfirmDialog(rootPane, result, "Message", -1, 1);
                    transporterModel.loadTransporterTable("", transporterTableModel);
                    transporterModel.loadTransporterTableFull("", transporterTableModelFull);
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            String result = transporterModel.removeTransporter(transporterNo);
            if (result.equals("Success")) {
                JOptionPane.showConfirmDialog(rootPane, result, "Message", -1, 1);
                transporterModel.loadTransporterTable("", transporterTableModel);
                transporterModel.loadTransporterTableFull("", transporterTableModelFull);
    ...
    private void transporterTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_transporterTableMouseClicked
        ...
        transporterNoField.setText(new String(transporterData[0] + ""));
        nameField.setText((String) transporterData[1]);
        nicField.setText((String) transporterData[2]);
        emailField.setText((String) transporterData[3]);
        contactNoField.setText((String) transporterData[4]);
        addressField.setText((String) transporterData[5]);
        cityField.setText((String) transporterData[6]);
        districtComboBox.setSelectedIndex((int) transporterData[7] - 1);
        provinceComboBox.setSelectedIndex((int) transporterData[8] - 1);

        if (transporterNoField.getText().length() > 0) {
...
//            java.util.logging.Logger.getLogger(TransporterManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        }
    ...
    private javax.swing.JTextField transporterNoField;
    private javax.swing.JTable transporterTable;
    private javax.swing.JTable transporterTableFull;
