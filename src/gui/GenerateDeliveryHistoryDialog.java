 ...
 */
public class GenerateDeliveryHistoryDialog extends javax.swing.JDialog {

    /**
     * Creates new form GenerateDeliveryHistoryDialog
     */
    static Logger logger = Logger.getLogger(GenerateDeliveryHistoryDialog.class.getName());
    
    String reportPath = "reports\\pamunuwila_hardware_delivery_history.jasper";
    Map m = new HashMap();
    
    public GenerateDeliveryHistoryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        logger.debug("Access to GenerateDeliveryHistoryDialog.java");
...
//            java.util.logging.Logger.getLogger(GenerateDeliveryHistoryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GenerateDeliveryHistoryDialog dialog = new GenerateDeliveryHistoryDialog(new javax.swing.JFrame(), true);
