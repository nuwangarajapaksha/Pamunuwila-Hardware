...
public class CustomerManager extends javax.swing.JFrame {
    ...
    DefaultTableModel customerTableModelFull;
    ...
    public CustomerManager() {
        ...
        customerTableModelFull = (DefaultTableModel) customerTableFull.getModel();

        customerModel = new CustomerModel();
        comboBoxLoadModel = new ComboBoxLoadModel();

        customerModel.loadCustomerTable("", customerTableModel);
        customerModel.loadCustomerTableFull("", customerTableModelFull);
    ...
    private void initComponents() {
        ...
        customerTableFull = new javax.swing.JTable();
        ...
        customerTableFull.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Customer No", "Name", "NIC", "Email", "Contact No", "Address", "City", "District", "Province"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        customerTableFull.setRowHeight(25);
        jScrollPane3.setViewportView(customerTableFull);
    ...
    private void keywordFieldFullKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keywordFieldFullKeyReleased
        ...
        customerModel.loadCustomerTableFull(keywordFull, customerTableModelFull);
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        if (name.equals("")) {
            ...
            if (!m.matches()) {
                ...
                String result = customerModel.registerCustomer(name, nic, email, contactNo, address, city, distictNo, provinceNo);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if (name.equals("")) {
            ...
            if (!m.matches()) {
                ...
                String result = customerModel.updateCustomer(customerNo, name, nic, email, contactNo, address, city, distictNo, provinceNo);
                if (result.equals("Success")) {
                    JOptionPane.showConfirmDialog(rootPane, result, "Message", -1, 1);
                    customerModel.loadCustomerTable("", customerTableModel);
                    customerModel.loadCustomerTableFull("", customerTableModelFull);
    ...
    private void customerTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_customerTableMouseClicked
        ...
        if (customerNoField.getText().length() > 0) {
...
//        }
    ...
    private javax.swing.JTable customerTableFull;
